...
static const _DataFrame_type_support_symbol_names_t _DataFrame_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ti_mmwave_msgs, msg, DataFrame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ti_mmwave_msgs, msg, DataFrame)),
  }
};
...
{
  return &::ti_mmwave_msgs::msg::rosidl_typesupport_cpp::DataFrame_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ti_mmwave_msgs, msg, DataFrame)() {
  return get_message_type_support_handle<ti_mmwave_msgs::msg::DataFrame>();
}
