...
#include "ti_mmwave_msgs/msg/detail/radar_scan__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ti_mmwave_msgs::msg::RadarScan & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ti_mmwave_msgs::msg::RadarScan & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ti_mmwave_msgs::msg::RadarScan;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ti_mmwave_msgs::msg::RadarScan *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ti_mmwave_msgs::msg::RadarScan *>(
    untyped_ros_message);
...
{
  return &ti_mmwave_msgs::msg::typesupport_fastrtps_cpp::_RadarScan__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ti_mmwave_msgs, msg, RadarScan)() {
  return &ti_mmwave_msgs::msg::typesupport_fastrtps_cpp::_RadarScan__handle;
}
