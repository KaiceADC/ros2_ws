...
#include "ti_mmwave_msgs/srv/detail/mm_wave_cli__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ti_mmwave_msgs::srv::MMWaveCLI_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ti_mmwave_msgs::srv::MMWaveCLI_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ti_mmwave_msgs::srv::MMWaveCLI_Request *>(
    untyped_ros_message);
...
{
  return &ti_mmwave_msgs::srv::typesupport_fastrtps_cpp::_MMWaveCLI_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ti_mmwave_msgs::srv::MMWaveCLI_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ti_mmwave_msgs::srv::MMWaveCLI_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ti_mmwave_msgs::srv::MMWaveCLI_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ti_mmwave_msgs::srv::typesupport_fastrtps_cpp::_MMWaveCLI_Response__handle;
}
...
{
  return &ti_mmwave_msgs::srv::typesupport_fastrtps_cpp::_MMWaveCLI__handle;
}
