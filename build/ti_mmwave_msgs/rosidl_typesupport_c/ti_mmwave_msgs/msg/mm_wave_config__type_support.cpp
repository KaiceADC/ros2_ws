...
static const _MMWaveConfig_type_support_symbol_names_t _MMWaveConfig_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ti_mmwave_msgs, msg, MMWaveConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_msgs, msg, MMWaveConfig)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ti_mmwave_msgs, msg, MMWaveConfig)() {
  return &::ti_mmwave_msgs::msg::rosidl_typesupport_c::MMWaveConfig_message_type_support_handle;
}
