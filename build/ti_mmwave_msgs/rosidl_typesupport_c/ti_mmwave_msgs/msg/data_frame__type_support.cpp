...
static const _DataFrame_type_support_symbol_names_t _DataFrame_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ti_mmwave_msgs, msg, DataFrame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_msgs, msg, DataFrame)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ti_mmwave_msgs, msg, DataFrame)() {
  return &::ti_mmwave_msgs::msg::rosidl_typesupport_c::DataFrame_message_type_support_handle;
}
