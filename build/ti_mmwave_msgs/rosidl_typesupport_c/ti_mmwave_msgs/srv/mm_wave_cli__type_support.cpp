...
static const _MMWaveCLI_Request_type_support_symbol_names_t _MMWaveCLI_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ti_mmwave_msgs, srv, MMWaveCLI_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_msgs, srv, MMWaveCLI_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ti_mmwave_msgs, srv, MMWaveCLI_Request)() {
  return &::ti_mmwave_msgs::srv::rosidl_typesupport_c::MMWaveCLI_Request_message_type_support_handle;
}
...
static const _MMWaveCLI_Response_type_support_symbol_names_t _MMWaveCLI_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ti_mmwave_msgs, srv, MMWaveCLI_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_msgs, srv, MMWaveCLI_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ti_mmwave_msgs, srv, MMWaveCLI_Response)() {
  return &::ti_mmwave_msgs::srv::rosidl_typesupport_c::MMWaveCLI_Response_message_type_support_handle;
}
...
static const _MMWaveCLI_type_support_symbol_names_t _MMWaveCLI_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ti_mmwave_msgs, srv, MMWaveCLI)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_msgs, srv, MMWaveCLI)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ti_mmwave_msgs, srv, MMWaveCLI)() {
  return &::ti_mmwave_msgs::srv::rosidl_typesupport_c::MMWaveCLI_service_type_support_handle;
}
