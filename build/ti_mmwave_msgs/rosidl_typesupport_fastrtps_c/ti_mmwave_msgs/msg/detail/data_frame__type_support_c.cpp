...
#include "ti_mmwave_msgs/msg/detail/data_frame__rosidl_typesupport_fastrtps_c.h"
...
using _DataFrame__ros_msg_type = ti_mmwave_msgs__msg__DataFrame;
...
size_t get_serialized_size_ti_mmwave_msgs__msg__DataFrame(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DataFrame__ros_msg_type * ros_message = static_cast<const _DataFrame__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DataFrame__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ti_mmwave_msgs__msg__DataFrame(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ti_mmwave_msgs
size_t max_serialized_size_ti_mmwave_msgs__msg__DataFrame(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ti_mmwave_msgs__msg__DataFrame;
    is_plain =
      (
...
static size_t _DataFrame__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ti_mmwave_msgs__msg__DataFrame(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ti_mmwave_msgs, msg, DataFrame)() {
