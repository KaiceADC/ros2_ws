...
ti_mmwave_msgs__msg__DataFrame__init(ti_mmwave_msgs__msg__DataFrame * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    ti_mmwave_msgs__msg__DataFrame__fini(msg);
    return false;
  }
  // data
...
ti_mmwave_msgs__msg__DataFrame__create()
{
  ...
  ti_mmwave_msgs__msg__DataFrame * msg = (ti_mmwave_msgs__msg__DataFrame *)allocator.allocate(sizeof(ti_mmwave_msgs__msg__DataFrame), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ti_mmwave_msgs__msg__DataFrame));
  bool success = ti_mmwave_msgs__msg__DataFrame__init(msg);
  if (!success) {
...
ti_mmwave_msgs__msg__DataFrame__Sequence__init(ti_mmwave_msgs__msg__DataFrame__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ti_mmwave_msgs__msg__DataFrame * data = NULL;

  if (size) {
    data = (ti_mmwave_msgs__msg__DataFrame *)allocator.zero_allocate(size, sizeof(ti_mmwave_msgs__msg__DataFrame), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ti_mmwave_msgs__msg__DataFrame__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ti_mmwave_msgs__msg__DataFrame__fini(&data[i - 1]);
      }
...
ti_mmwave_msgs__msg__DataFrame__Sequence__fini(ti_mmwave_msgs__msg__DataFrame__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ti_mmwave_msgs__msg__DataFrame__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ti_mmwave_msgs__msg__DataFrame__Sequence * array = (ti_mmwave_msgs__msg__DataFrame__Sequence *)allocator.allocate(sizeof(ti_mmwave_msgs__msg__DataFrame__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ti_mmwave_msgs__msg__DataFrame__Sequence__init(array, size);
  if (!success) {
...
ti_mmwave_msgs__msg__DataFrame__Sequence__destroy(ti_mmwave_msgs__msg__DataFrame__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ti_mmwave_msgs__msg__DataFrame__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ti_mmwave_msgs__msg__DataFrame__Sequence__are_equal(const ti_mmwave_msgs__msg__DataFrame__Sequence * lhs, const ti_mmwave_msgs__msg__DataFrame__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ti_mmwave_msgs__msg__DataFrame__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ti_mmwave_msgs__msg__DataFrame__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ti_mmwave_msgs__msg__DataFrame);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ti_mmwave_msgs__msg__DataFrame * data =
      (ti_mmwave_msgs__msg__DataFrame *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ti_mmwave_msgs__msg__DataFrame__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ti_mmwave_msgs__msg__DataFrame__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ti_mmwave_msgs__msg__DataFrame__copy(
