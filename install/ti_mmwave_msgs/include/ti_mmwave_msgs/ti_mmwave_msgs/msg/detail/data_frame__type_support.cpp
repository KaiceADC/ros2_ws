...
{
  new (message_memory) ti_mmwave_msgs::msg::DataFrame(_init);
}

void DataFrame_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ti_mmwave_msgs::msg::DataFrame *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DataFrame_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(ti_mmwave_msgs::msg::DataFrame, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ti_mmwave_msgs::msg::DataFrame, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DataFrame_message_members = {
  ...
  2,  // number of fields
  sizeof(ti_mmwave_msgs::msg::DataFrame),
...
get_message_type_support_handle<ti_mmwave_msgs::msg::DataFrame>()
{
  return &::ti_mmwave_msgs::msg::rosidl_typesupport_introspection_cpp::DataFrame_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ti_mmwave_msgs, msg, DataFrame)() {
  return &::ti_mmwave_msgs::msg::rosidl_typesupport_introspection_cpp::DataFrame_message_type_support_handle;
}
